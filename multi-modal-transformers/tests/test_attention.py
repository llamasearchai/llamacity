...
class TestMultiHeadCrossAttention:
    def test_init(self):
        ...
        attn = MultiHeadCrossAttention(
            query_dim=query_dim, key_dim=key_dim, num_heads=num_heads, dropout=dropout
        )
...
class TestLinearAttention:
    def test_init(self):
        ...
        attn = LinearAttention(
            hidden_size=hidden_size, num_heads=num_heads, dropout=dropout, dim=dim
        )
    ...
    def test_forward(self):
        ...
        attn = LinearAttention(hidden_size=hidden_size, num_heads=num_heads, dim=dim)
