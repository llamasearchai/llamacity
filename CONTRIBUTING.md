# Contributing to LlamaCity

Thank you for your interest in contributing to LlamaCity! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaCity:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamacity.git
   cd llamacity
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamacity.git
   ```
...
By contributing to LlamaCity, you agree that your contributions will be licensed under the project's MIT License.
